import{_ as n,c as a,o as p,ar as l}from"./chunks/framework.B7hNqQXE.js";const e="/BanBing/assets/2.nEeMsI9e.png",i="/BanBing/assets/1.Dti7ZgwN.png",g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"notes/docker/02docker部署.md","filePath":"notes/docker/02docker部署.md"}'),c={name:"notes/docker/02docker部署.md"};function t(o,s,r,d,h,u){return p(),a("div",null,s[0]||(s[0]=[l('<h2 id="使用-sh-脚本一键-在-docker-部署-web-项目" tabindex="-1">使用 .sh 脚本一键 在 docker 部署 web 项目 <a class="header-anchor" href="#使用-sh-脚本一键-在-docker-部署-web-项目" aria-label="Permalink to &quot;使用 .sh 脚本一键 在 docker 部署 web 项目&quot;">​</a></h2><h3 id="拉取镜像" tabindex="-1">拉取镜像 <a class="header-anchor" href="#拉取镜像" aria-label="Permalink to &quot;拉取镜像&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>docker pull nginx</span></span></code></pre></div><p>出现以下输出即拉取成功 <img src="'+e+'" alt="ACE"> 拉取完可通过 <code>docker images</code> 查看镜像列表 <img src="'+i+`" alt="ACE"></p><h3 id="项目准备" tabindex="-1">项目准备 <a class="header-anchor" href="#项目准备" aria-label="Permalink to &quot;项目准备&quot;">​</a></h3><p>例如 vite 项目 ，我们需要在更目录 添加 nginx 配置文件 default.conf 和 docker 配置文件 Dockerfile 分别写入一下内容</p><ul><li>default.conf</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>server {</span></span>
