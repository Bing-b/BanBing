...
<span class="line"><span>config.ts</span></span></code></pre></div><h5 id="_1-2-vue-组件命名" tabindex="-1">1.2 Vue 组件命名 <a class="header-anchor" href="#_1-2-vue-组件命名" aria-label="Permalink to &quot;1.2 Vue 组件命名&quot;">​</a></h5><p>参考官方风格指南 <a href="https://cn.vuejs.org/style-guide/" target="_blank" rel="noreferrer">https://cn.vuejs.org/style-guide/</a></p>`,17)]))}const g=a(l,[["render",i]]);export{u as __pageData,g as default};
